...
var translator = function translator() {
    ...
    var performReplacements = function(string, replacements) {
        if (string !== null && replacements != null && typeof replacements === "object") {
        ...
        if (_initialized) {
            ...
            if (_cache.get(translator.instance.locale + "." + key) != null) {
                ...
                if (root) {
                    ...
                    var chunks = key.split(".");
                    var _walkerIndex = 0;
                    var root = _structure[translator.instance.localeDefault][chunks[_walkerIndex]];
                    ...
                    if (root) {
                        // Store in cache for later quick access
                        _cache.set(translator.instance.localeDefault + "." + key, root);
                        return performReplacements(root, replacements);
                    } else {
